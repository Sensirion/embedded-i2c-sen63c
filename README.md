# Sensirion I2C SEN63C embedded Library

This document explains how to set up a SEN63C sensor to run on an embedded device using the I²C interface.
...
Use the following description to connect your SEN63C:
...
5. Run the compiled executable with `./sen63c_i2c_example_usage`
...
5. Run the compiled executable with `./sen63c_test_hw_i2c`.
